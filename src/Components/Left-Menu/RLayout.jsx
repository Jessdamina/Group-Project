export const RLayout = ({ imagesrc, title, description, category }) => {
    return (
        <div className="bg-white dark:bg-[#242526] w-70 pt-3 h-60">
            ...
            <h3 className='text-[#2B2B2B] text-md pt-3 dark:text-[#E4E6EB] font-medium pl-5'>{category}</h3>
            ...
            <div className="flex gap-2 pl-5 pt-5 items-center m-auto">
                ...
                <div>
                    <h3 className="text-[#2B2B2B] dark:text-[#E4E6EB] text-md font-medium">{title}</h3>
