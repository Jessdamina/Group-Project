...
function Profile() {
    return (
        <div className="max-w-70 pt-2 m-auto">
            <div>
            ...
            <div className="flex justify-center pt-2">
                ...
                <div className="grid gap-2 justify-items-end max-w-fit pt-5">
                    <p className="text-md text-[#767676]">24</p>
                    <p className="text-md text-[#767676]">BD</p>
                    <p className="text-md text-green-600">Available</p>
                    <p className="text-md text-[#767676]">Dhaka, Bangladesh</p>
                </div>
            </div>
            <img src="Line 6.png" className="items-center
                pt-5 m-auto w-full"  />
