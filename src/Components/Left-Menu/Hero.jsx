function Hero() {
    ...
    return (
        <div className="hidden relative left-28 lg:flex overflow-hidden flex-shrink-0 justify-center items-center m-auto bg-white dark:bg-[#242526] h-full w-215 max-w-4xl md:py-7">
